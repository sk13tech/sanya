...
export default function Hero({ ready }: { ready: boolean }) {
  ...
  return (
    <section ref={ref} className="relative h-[170vh]">
      <div className="hero-screen sticky top-0 flex h-[100svh] flex-col items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            <motion.h1 variants={item} className="mt-10">
              <span className="hero-happy gold-shimmer block pr-3 font-display text-[clamp(2.4rem,6.5vw,5.5rem)] italic leading-[0.9]">
                Happy
              </span>
              <span className="hero-title mt-2 block font-sans text-[clamp(2.75rem,12vw,10.5rem)] font-extrabold leading-[0.95] tracking-[-0.04em]">
        ...
        <motion.div
          ...
          className="hero-hint absolute bottom-[max(1rem,env(safe-area-inset-bottom))] z-10 flex flex-col items-center gap-2.5 sm:bottom-8 sm:gap-3"
        >
