...
import { stopVocalBirthday } from "../audio/vocalSong";
import { playLetterMusic, stopLetterMusic } from "../audio/letterMusic";
...
const LINES = [
  ...
  `Tumhe maine pehli baar kab pasand kiya tha, woh shayad mujhe exactly yaad na ho… Lekin itna zaroor yaad hai ki tumhe pasand karna kab ek simple feeling se meri sabse beautiful feeling ban gaya, mujhe khud pata nahi chala.`,
  `2024 se lekar aaj tak waqt kitna badal gaya… bahut kuch badla, log badle, situations badli… lekin tumhare liye mere dil mein jo jagah hai, woh nahi badli.`,
  `Kabhi-kabhi bina kisi reason ke tumhara khayal aa jaata hai. Tumhari smile yaad aati hai, tumhari baatein yaad aati hain… aur pata nahi kyun, mere face par bhi ek smile aa jaati hai.`,
  `Tumse baat karna mere liye sirf conversation nahi hai. Kabhi-kabhi tumhare ek simple se "hello" mein bhi woh sukoon milta hai jo poore din mein kahin aur nahi milta.`,
  ...
  `Lekin agar kabhi tum mujhe apni life mein jagah do, toh main ek cheez zaroor chahta hoon — tumhare difficult days mein tumhe akela feel na hone doon. Tumhari smile ko protect karne ki wajah banu. Aur jab duniya tumhe samajhne mein fail ho jaaye, tab tumhe ek aisa insaan mil sake jo tumhe bina judge kiye sun sake. ❤️`,
  `Main chahta hoon ki tum meri best friend, meri comfort, meri favourite person bano. Jiske saath main bina filter ke khud reh sakun. Jiske saath stupid baaton par has sakun. Jiske saath silence bhi awkward na lage. Aur jiske saath future ke chhote-chhote dreams dekhna bhi beautiful lage.`,
  `Sach bolun? -------- mujhe tumhe samajhna hai. Tumhari care karni hai. Tumhari respect karni hai. Tumhare saath grow karna hai. Aur har din tumhe choose karna hai. ❤️`,
  `Mujhe nahi pata tumhare dil mein mere liye kya hai. Shayad kuch hai… shayad kuch nahi hai. Aur main tumse koi zabardasti ka answer nahi chahta. Kyunki jo feeling mere andar 2024 mein shuru hui thi, woh waqt ke saath khatam nahi hui…`,
  `Aur agar kabhi tumhare dil mein bhi mere liye thodi si jagah ho… toh main chahta hoon ki hum ek beautiful beginning karein. Koi jaldi nahi. Koi pressure nahi. Bas tum aur main… aur ek genuine chance. ❤️`,
  `Aur haan… Agar tum kabhi mujhse poochogi ki "Tum mujhe itna kyun chahte ho?" Toh shayad mere paas koi perfect answer nahi hoga. Main bas itna kahunga — "Pata nahi… bas tum ho. Aur mere dil ko tum hi achhi lagti ho."`,
];
...
export default function GreetingCard() {
  ...
  const openCard = () => {
    if (open) return;
    // Audio handoff: the cake song ends and the letter theme starts from
    // this user tap, so browser autoplay policies cannot block it.
    stopVocalBirthday();
    playLetterMusic();
    setOpen(true);
    playPop(0.5);
